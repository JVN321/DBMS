...
export default function LandingPage() {
  ...
  // Single control point for landing background video opacity
  const landingVideoOpacity = 0.40;
    ...
    <div className="landing-root">
      ...
      <div className="cyber-network-bg" aria-hidden="true">
        <VideoBackground
          ...
          videoOpacity={landingVideoOpacity}
          overlayOpacity={0}
        />
      </div>
      ...
      <section className="landing-hero">
        <div className="relative z-10 landing-hero-content">
          ...
          <h1 className="landing-hero-title">
            <span className="landing-glitch whitespace-nowrap" data-text="Distributed Blockchain">
